...
import com.emerchat.server.client.ChatClient;
import com.emerchat.server.host.ChatServer;

import java.io.IOException;


public class ChatActivity extends MyAppCompatActivity implements MessageListener {
    private TextView mMessageTextView,ipadd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create the server - don't startClient it yet
        mChatClient = new ChatClient(this,this);
    }
